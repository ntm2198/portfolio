const projectSource = window.portfolioProjects ?? [
  {
    title: "Creative Coding Workshop Series",
    label: "Code + Studio",
    theme: "#a8d8c2",
    overview:
  ...
  },
  {
    ...
    goal:
      "Help learners connect abstract logic to tangible inputs, outputs, constraints, and debugging habits.",
  ...
  },
  {
    ...
    theme: "#d47654",
    overview:
      "A strategy-game design unit where students model probability, feedback loops, and decision trees through tabletop-inspired systems.",
    goal:
      "Make randomness, fairness, and systems thinking visible through playtesting and computational modeling.",
    tech: ["Python", "JavaScript", "Tabletop design"],
    impact:
      "Learners compare simulated outcomes with human play, then tune rules with evidence instead of guesswork.",
    visual: "game",
  ...
  },
  {
    ...
    goal:
      "Create a classroom culture where technical skill grows through design choices, shared materials, and reflective revision.",
  ...
  },
  {
    ...
    theme: "#7c6aa6",
    overview:
      "A museum-inspired prototype that combines code, touch, movement, and playful prompts to teach a technical concept in public.",
    goal:
      "Design an exhibit-like experience where visitors learn by testing hypotheses and seeing immediate visual feedback.",
    tech: ["JavaScript", "Raspberry Pi", "UX prototyping"],
    impact:
      "The format supports curiosity, collaboration, and multiple paths through a concept rather than one fixed answer.",
    visual: "installation",
